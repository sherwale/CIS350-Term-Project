...
public class ConnectGridLogicComputer extends CreateGridComputer {
    /**
     ...
     */
    public static int openingComputer(final int xLocation) {
     ...
     */
    public static int checkVerticalComputer() {
        int check = 0;
        int check2 = 0;
     ...
     * @return returns which player won or if neither did.
     */
    public static int checkHorizontalComputer() {
        int check = 0;
        int check2 = 0;
